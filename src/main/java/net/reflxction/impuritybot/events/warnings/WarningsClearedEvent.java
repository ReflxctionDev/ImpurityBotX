...
/**
 * Fired when a user's warnings have been cleared
 */
public class WarningsClearedEvent extends WarningEvent {
     ...
     */
    public WarningsClearedEvent(User target, User executor, TextChannel channel) {
