...
public enum EnumTeams implements IEnumInfo {
    ...
    EVENTS("Events Team", "The events team aims at creating and proposing ideas for events, and implement said events, making sure everyone has fun and everything runs smoothly. It is also responsible for taking feedback from members/participants of events, and to tailor events to the interests and preferences of Impurity members. It is led by <@149763661630537729> and <@348284085971451904>. You can join by contacting them. Like the applications team, accepted members will be released in waves."),
