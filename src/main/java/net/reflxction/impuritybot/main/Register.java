...
import net.reflxction.impuritybot.commands.points.ManagePointsCommand;
...
public class Register {
    ...
    private static AbstractCommand[] abstractCommands = {new Announce(), new About(), new Delete(), new EmbedMaker(), new GuildInfo(),
            ...
            new Transfer(), new Open(), new Agree(), new Accept(), new Slots(), new SetLevel(), new Calendar(), new MakeCalendar(), new PointsBalance(), new ManagePointsCommand()};
